...
, config ? {}
# allows to override dependencies of the hasktorch-yolo project without modifications
, sourcesOverride ? {}
...
let
  ...
  self = {
    ...
    inherit (haskellPackages.hasktorch-yolo.identifier) version;
